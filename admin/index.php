            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages/stats.php">Stats</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col">
                    <div class="card text-white bg-primary mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi debitis blanditiis suscipit necessitatibus quos temporibus explicabo nam dicta corporis rem ipsum magnam commodi quis nulla similique, fugit inventore ex non.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div class="card text-white bg-primary mb-3">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Text-2</h5>
                            <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dicta rem repellendus totam iste. Quis, repudiandae eligendi laboriosam iusto neque voluptatum impedit doloremque illum fugiat odit necessitatibus, debitis facere labore quidem.</p>
                        </div>
                    </div>
                </div>
                <div class="col">
